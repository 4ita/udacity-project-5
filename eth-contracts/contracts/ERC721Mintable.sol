...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "msg.sender is not the owner");
        _;
    }
    //  4) fill out the transferOwnership function
    //  5) create an event that emits anytime ownerShip is transfered (including in the constructor)
    event Transfer(address newOwner);
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, "You are already the owner");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(ownerOf(tokenId), to), "require the msg.sender to be the owner of the contract or isApprovedForAll() to be true");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "Not need to set approval");
...
contract RealEstateMarketplaceToken is ERC721Metadata {
    ...
    ) public ERC721Metadata(_name, _symbol, _baseTokenURI) {}
